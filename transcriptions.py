...
def upload_to_assembly_ai(file_path):
	headers = {'authorization': api_key} # create a system variable name 'ASSEMBLY_AI_KEY' and the value is your API key (in Assembly AI)
...
if __name__ == '__main__':
    ...
    # In the below code, the audio start from 10m and end at 15m
